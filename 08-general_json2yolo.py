# Description
# COCO json 转 YOLO txt
# The https://github.com/ultralytics/COCO2YOLO repo contains code to convert JSON datasets into YOLO (darknet) format. 
# The code works on Linux, MacOS and Windows. 
...
def convert_coco_json(json_dir='../coco/annotations/', use_segments=False, cls91to80=False):
    ...
    # Import json
    for json_file in tqdm(sorted(Path(json_dir).resolve().glob('*.json'))): 
...
if __name__ == '__main__':
    ...
    if source == 'COCO':
        convert_coco_json('IMG_AUG_COCO\COCOData_HLGSeg\coco_JSON',  # directory with *.json
                          use_segments=True,  #语义分割  
                          cls91to80=False)    #注意#Line 294  类别从0开始 2023.05.03 
